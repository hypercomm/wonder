...
//		this.signaling_server = connectURI;
	 ...
	 */
	MessagingStub_IMS_External.prototype.sendMessage = function (message) {
		/*
	 ...
	 */
	MessagingStub_IMS_External.prototype.connect = function (ownRtcIdentity, credentials, callbackFunction) {
	 ...
	 */
	MessagingStub_IMS_External.prototype.disconnect = function ()
	{
